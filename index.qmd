...
::: {.plate-caption}
*From the **band** to **coordinates** — a landmark grid on the birth–death plane, a hat over each cell, an analytic weight per scale.*
:::
...
<!-- landmarks at cover centres (muted, like neighbors in panel c) -->
...
::: {.standfirst style="font-style: normal; font-size: 0.95em; margin: -0.3rem 0 0.3rem;"}
Stack scales $R_1 < \cdots < R_N$ with weights $w_k$ chosen *analytically* to maximise $\lambda$.
:::
...
Every parameter — *chosen analytically*. No held-out tuning, no random seeds.
:::
...
<!-- 5-stage flow: shape → PD → grid+hat → multi-scale Φ → certify -->

<!-- Stage 1: SHAPE -->
<g fill="#6c1d1a" stroke="none">
<circle cx="46" cy="38" r="1.7"/>
<circle cx="52" cy="32" r="1.7"/>
<circle cx="56" cy="42" r="1.7"/>
<circle cx="42" cy="46" r="1.7"/>
<circle cx="50" cy="50" r="1.7"/>
<circle cx="60" cy="36" r="1.7"/>
</g>
<text x="50" y="70" fill="#57473a" font-family="Alegreya SC, EB Garamond, Georgia, serif" font-size="9" letter-spacing="1.3" text-anchor="middle">SHAPE</text>

<!-- arrow -->
<g stroke="#6c1d1a" fill="none" stroke-width="0.9">
<line x1="78" y1="42" x2="118" y2="42"/>
<path d="M 110 37 L 118 42 L 110 47"/>
</g>

<!-- Stage 2: PD -->
<g stroke="#2b211a" fill="none" stroke-width="0.7">
<line x1="135" y1="60" x2="195" y2="60"/>
<line x1="135" y1="60" x2="135" y2="14"/>
</g>
<line x1="135" y1="60" x2="180" y2="14" stroke="#57473a" stroke-width="0.5" stroke-dasharray="2 2" fill="none"/>
<g fill="#6c1d1a" stroke="none">
<circle cx="146" cy="36" r="1.6"/>
<circle cx="158" cy="28" r="1.6"/>
<circle cx="166" cy="42" r="1.6"/>
</g>
<text x="167" y="70" fill="#57473a" font-family="Alegreya SC, EB Garamond, Georgia, serif" font-size="9" letter-spacing="1.3" text-anchor="middle">PD</text>

<!-- arrow -->
<g stroke="#6c1d1a" fill="none" stroke-width="0.9">
<line x1="210" y1="42" x2="250" y2="42"/>
<path d="M 242 37 L 250 42 L 242 47"/>
</g>

<!-- Stage 3: GRID + HAT -->
<g stroke="#2b211a" fill="none" stroke-width="0.5">
<line x1="270" y1="60" x2="335" y2="60"/>
<line x1="270" y1="60" x2="270" y2="14"/>
</g>
<line x1="270" y1="60" x2="320" y2="14" stroke="#57473a" stroke-width="0.4" stroke-dasharray="2 2" fill="none"/>
<g fill="#2b211a" stroke="none">
<circle cx="282" cy="50" r="1.4"/>
<circle cx="294" cy="38" r="1.4"/>
<circle cx="282" cy="38" r="1.4"/>
<circle cx="306" cy="26" r="1.4"/>
<circle cx="294" cy="26" r="1.4"/>
<circle cx="282" cy="26" r="1.4"/>
</g>
<path d="M 286 50 Q 297 18, 308 50 Z" fill="#6c1d1a" fill-opacity="0.30" stroke="#6c1d1a" stroke-width="0.6"/>
<text x="305" y="70" fill="#57473a" font-family="Alegreya SC, EB Garamond, Georgia, serif" font-size="9" letter-spacing="1.3" text-anchor="middle">GRID + HAT</text>

<!-- arrow -->
<g stroke="#6c1d1a" fill="none" stroke-width="0.9">
<line x1="350" y1="42" x2="390" y2="42"/>
<path d="M 382 37 L 390 42 L 382 47"/>
</g>

<!-- Stage 4: MULTI-SCALE Φ -->
<g stroke="#2b211a" fill="none" stroke-width="0.9">
<path d="M 425 18 L 418 18 L 418 66 L 425 66"/>
<path d="M 460 18 L 467 18 L 467 66 L 460 66"/>
</g>
<g stroke="#c8b894" stroke-width="0.4" stroke-dasharray="1.5 1" fill="none">
<line x1="418" y1="34" x2="467" y2="34"/>
<line x1="418" y1="50" x2="467" y2="50"/>
</g>
<g fill="#2b211a" stroke="none" font-family="EB Garamond, Georgia, serif" font-size="8" text-anchor="middle">
<text x="442" y="29">Φ<tspan baseline-shift="sub" font-size="0.6em">R₁</tspan></text>
<text x="442" y="45">Φ<tspan baseline-shift="sub" font-size="0.6em">R₂</tspan></text>
<text x="442" y="61">⋮</text>
</g>
<text x="442" y="70" fill="#57473a" font-family="Alegreya SC, EB Garamond, Georgia, serif" font-size="9" letter-spacing="1.3" text-anchor="middle">Φ(A)</text>

<!-- arrow -->
<g stroke="#6c1d1a" fill="none" stroke-width="0.9">
<line x1="485" y1="42" x2="525" y2="42"/>
<path d="M 517 37 L 525 42 L 517 47"/>
</g>

<!-- Stage 5: CERTIFY (band) -->
<line x1="545" y1="62" x2="640" y2="62" stroke="#2b211a" stroke-width="0.8"/>
<line x1="545" y1="62" x2="545" y2="14" stroke="#2b211a" stroke-width="0.8"/>
<path d="M 545 62 L 640 18 L 640 24 L 555 62 Z" fill="#6c1d1a" fill-opacity="0.18" stroke="none"/>
<path d="M 545 62 L 640 18" stroke="#6c1d1a" stroke-width="1.2" fill="none"/>
<path d="M 555 62 L 580 52 L 605 38 L 640 24" stroke="#2b211a" stroke-width="1.0" fill="none" stroke-dasharray="2 1.5"/>
<text x="592" y="70" fill="#57473a" font-family="Alegreya SC, EB Garamond, Georgia, serif" font-size="9" letter-spacing="1.3" text-anchor="middle">CERTIFY</text>

<!-- final arrow + classifier label -->
<g stroke="#6c1d1a" fill="none" stroke-width="0.9">
<line x1="660" y1="42" x2="700" y2="42"/>
<path d="M 692 37 L 700 42 L 692 47"/>
</g>
</svg>
```
...
::: {.dispatches .fragment data-fragment-index="2" data-title="Closed-form throughout · Paper I" style="font-size: 0.82em; padding: 0.7rem 1.3rem 0.55rem; margin: 1.5rem auto 0.4rem;"}
- **Grid** $\mathbb{G}_R$ — $\{(mR, nR) : m\text{ odd},\, n\text{ even},\, n \geq m+3\}$.
- **Hat** $\varphi_{R,p}$ — $\bigl(\tfrac{3R}{2} - \|x - p\|_\infty\bigr)_+$.
- **Scales** $R_1 < \cdots < R_N$ — geometric progression from the data scale.
- **Weights** $w_k$ — $w_k^2 \propto (d_{k+1}^2 - d_k^2)/R_k^2$, the unique maximiser of $\lambda(\nu)$. [[☞]{.manicule}Onto theory]{.followup-stamp .tilt-c}
:::
